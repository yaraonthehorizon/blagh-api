...
import { BaseAuthProvider, AuthCredentials, AuthResult } from '../providers/base-auth-provider';
...
export class AuthService {
  ...
  private async initializeAuthModule(config?: any): Promise<void> {
    ...
    const authConfig = config?.auth || {
      ...
      allowMultipleProviders: process.env.AUTH_ALLOW_MULTIPLE_PROVIDERS === 'true',
      ...
      providers: {
        internal: {
          ...
          allowRegistration: process.env.AUTH_INTERNAL_ALLOW_REGISTRATION !== 'false',
          requireEmailVerification: process.env.AUTH_INTERNAL_REQUIRE_EMAIL_VERIFICATION === 'true',
          allowPasswordReset: process.env.AUTH_INTERNAL_ALLOW_PASSWORD_RESET !== 'false',
          bcryptRounds: parseInt(process.env.AUTH_INTERNAL_BCRYPT_ROUNDS || '12'),
          database: {
            userTable: process.env.AUTH_INTERNAL_USER_TABLE || 'users',
            tokenTable: process.env.AUTH_INTERNAL_TOKEN_TABLE || 'auth_tokens',
            sessionTable: process.env.AUTH_INTERNAL_SESSION_TABLE || 'auth_sessions'
          }
        },
        firebase: {
          enabled: process.env.AUTH_FIREBASE_ENABLED === 'true',
          projectId: process.env.AUTH_FIREBASE_PROJECT_ID || '',
          privateKeyId: process.env.AUTH_FIREBASE_PRIVATE_KEY_ID || '',
          ...
          authProviderX509CertUrl: process.env.AUTH_FIREBASE_AUTH_PROVIDER_X509_CERT_URL || '',
          clientX509CertUrl: process.env.AUTH_FIREBASE_CLIENT_X509_CERT_URL || '',
          adminSDK: {
            type: process.env.AUTH_FIREBASE_ADMIN_TYPE || 'service_account',
            project_id: process.env.AUTH_FIREBASE_ADMIN_PROJECT_ID || '',
            private_key_id: process.env.AUTH_FIREBASE_ADMIN_PRIVATE_KEY_ID || '',
            private_key: process.env.AUTH_FIREBASE_ADMIN_PRIVATE_KEY || '',
            client_email: process.env.AUTH_FIREBASE_ADMIN_CLIENT_EMAIL || '',
            client_id: process.env.AUTH_FIREBASE_ADMIN_CLIENT_ID || '',
            auth_uri: process.env.AUTH_FIREBASE_ADMIN_AUTH_URI || '',
            token_uri: process.env.AUTH_FIREBASE_ADMIN_TOKEN_URI || '',
            auth_provider_x509_cert_url: process.env.AUTH_FIREBASE_ADMIN_AUTH_PROVIDER_X509_CERT_URL || '',
            client_x509_cert_url: process.env.AUTH_FIREBASE_ADMIN_CLIENT_X509_CERT_URL || ''
          }
        },
        oauth: {
          ...
          providers: {
            google: {
              enabled: process.env.AUTH_OAUTH_GOOGLE_ENABLED === 'true',
              clientId: process.env.AUTH_OAUTH_GOOGLE_CLIENT_ID || '',
              clientSecret: process.env.AUTH_OAUTH_GOOGLE_CLIENT_SECRET || '',
              callbackUrl: process.env.AUTH_OAUTH_GOOGLE_CALLBACK_URL || '',
              scope: (process.env.AUTH_OAUTH_GOOGLE_SCOPE || 'profile,email').split(',')
            },
            github: {
              enabled: process.env.AUTH_OAUTH_GITHUB_ENABLED === 'true',
              clientId: process.env.AUTH_OAUTH_GITHUB_CLIENT_ID || '',
              clientSecret: process.env.AUTH_OAUTH_GITHUB_CLIENT_SECRET || '',
              callbackUrl: process.env.AUTH_OAUTH_GITHUB_CALLBACK_URL || '',
              scope: (process.env.AUTH_OAUTH_GITHUB_SCOPE || 'user:email').split(',')
            },
            facebook: {
              enabled: process.env.AUTH_OAUTH_FACEBOOK_ENABLED === 'true',
              clientId: process.env.AUTH_OAUTH_FACEBOOK_CLIENT_ID || '',
              clientSecret: process.env.AUTH_OAUTH_FACEBOOK_CLIENT_SECRET || '',
              callbackUrl: process.env.AUTH_OAUTH_FACEBOOK_CALLBACK_URL || '',
              scope: (process.env.AUTH_OAUTH_FACEBOOK_SCOPE || 'email').split(',')
            },
            twitter: {
              enabled: process.env.AUTH_OAUTH_TWITTER_ENABLED === 'true',
              clientId: process.env.AUTH_OAUTH_TWITTER_CLIENT_ID || '',
              clientSecret: process.env.AUTH_OAUTH_TWITTER_CLIENT_SECRET || '',
              callbackUrl: process.env.AUTH_OAUTH_TWITTER_CALLBACK_URL || '',
              scope: (process.env.AUTH_OAUTH_TWITTER_SCOPE || 'tweet.read,users.read').split(',')
            },
            linkedin: {
              enabled: process.env.AUTH_OAUTH_LINKEDIN_ENABLED === 'true',
              clientId: process.env.AUTH_OAUTH_LINKEDIN_CLIENT_ID || '',
              clientSecret: process.env.AUTH_OAUTH_LINKEDIN_CLIENT_SECRET || '',
              callbackUrl: process.env.AUTH_OAUTH_LINKEDIN_CALLBACK_URL || '',
              scope: (process.env.AUTH_OAUTH_LINKEDIN_SCOPE || 'r_liteprofile,r_emailaddress').split(',')
            },
            microsoft: {
              enabled: process.env.AUTH_OAUTH_MICROSOFT_ENABLED === 'true',
              clientId: process.env.AUTH_OAUTH_MICROSOFT_CLIENT_ID || '',
              clientSecret: process.env.AUTH_OAUTH_MICROSOFT_CLIENT_SECRET || '',
              callbackUrl: process.env.AUTH_OAUTH_MICROSOFT_CALLBACK_URL || '',
              scope: (process.env.AUTH_OAUTH_MICROSOFT_SCOPE || 'user.read').split(',')
            },
            apple: {
              enabled: process.env.AUTH_OAUTH_APPLE_ENABLED === 'true',
              clientId: process.env.AUTH_OAUTH_APPLE_CLIENT_ID || '',
              clientSecret: process.env.AUTH_OAUTH_APPLE_CLIENT_SECRET || '',
              callbackUrl: process.env.AUTH_OAUTH_APPLE_CALLBACK_URL || '',
              scope: (process.env.AUTH_OAUTH_APPLE_SCOPE || 'name,email').split(',')
            },
            discord: {
              enabled: process.env.AUTH_OAUTH_DISCORD_ENABLED === 'true',
              clientId: process.env.AUTH_OAUTH_DISCORD_CLIENT_ID || '',
              clientSecret: process.env.AUTH_OAUTH_DISCORD_CLIENT_SECRET || '',
              callbackUrl: process.env.AUTH_OAUTH_DISCORD_CALLBACK_URL || '',
              scope: (process.env.AUTH_OAUTH_DISCORD_SCOPE || 'identify,email').split(',')
            }
          }
        },
        sms: {
          ...
          twilio: {
            accountSid: process.env.AUTH_SMS_TWILIO_ACCOUNT_SID || '',
            authToken: process.env.AUTH_SMS_TWILIO_AUTH_TOKEN || '',
            fromNumber: process.env.AUTH_SMS_TWILIO_FROM_NUMBER || ''
          },
          aws: {
            accessKeyId: process.env.AUTH_SMS_AWS_ACCESS_KEY_ID || '',
            secretAccessKey: process.env.AUTH_SMS_AWS_SECRET_ACCESS_KEY || '',
        ...
        email: {
          ...
          nodemailer: {
            ...
            port: parseInt(process.env.AUTH_EMAIL_NODEMAILER_PORT || '587'),
            secure: process.env.AUTH_EMAIL_NODEMAILER_SECURE === 'true',
            auth: {
          ...
          aws: {
            accessKeyId: process.env.AUTH_EMAIL_AWS_ACCESS_KEY_ID || '',
            secretAccessKey: process.env.AUTH_EMAIL_AWS_SECRET_ACCESS_KEY || '',
            region: process.env.AUTH_EMAIL_AWS_REGION || 'us-east-1',
    ...
    this.authModule = new AuthModule({ enabled: true, config: {} }, pluginContext);
  ...
  async login(credentials: LoginData, provider: string = 'internal'): Promise<AuthResult> {
    ...
    if (result.success && result.token && result.refreshToken) {
      ...
      const refreshDecoded = jwt.verify(result.refreshToken, jwtSecret) as any;
  ...
  async register(userData: RegisterData, provider: string = 'internal'): Promise<AuthResult> {
    // Wait for auth module to be initialized
    await this.initializationPromise;
  ...
  async refreshToken(refreshToken: string): Promise<AuthResult> {
    try {
      ...
      if (!tokenDoc) {
        return { success: false, error: 'Invalid or expired refresh token', provider: 'internal' };
      }
      ...
      return { success: false, error: error.message || 'Internal error', provider: 'internal' };
    }
  }
  ...
  async verifyEmail(email: string, code: string): Promise<any> {
    ...
    if (typeof activeProvider.verifyEmail !== 'function') {
      throw new Error('Current auth provider does not support email verification');
    }
  ...
  async sendVerificationCode(email: string): Promise<void> {
    ...
    if (typeof activeProvider.sendVerificationCode !== 'function') {
      throw new Error('Current auth provider does not support sending verification codes');
    }
  ...
  async sendPasswordResetCode(email: string): Promise<void> {
    ...
    if (typeof activeProvider.sendPasswordResetCode !== 'function') {
      throw new Error('Current auth provider does not support password reset');
    }
  ...
  async finishWebAuthnRegistration(userId: string, credential: any): Promise<any> {
  ...
  async finishWebAuthnAuthentication(email: string, credential: any): Promise<any> {
  ...
  async getUserSessions(userId: string): Promise<any[]> {
    const sessions = await TokenModel.find({
      ...
      isActive: true,
      expiresAt: { $gt: new Date() }
    }).select('deviceInfo ipAddress createdAt lastUsedAt').lean();
